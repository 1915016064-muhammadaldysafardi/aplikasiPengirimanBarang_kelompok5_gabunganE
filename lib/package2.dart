...
class MyPackage2 extends StatelessWidget {
  const MyPackage2({Key? key}) : super(key: key);
...
class MyPackage2Page extends StatefulWidget {
  const MyPackage2Page({Key? key}) : super(key: key);

  @override
  State<MyPackage2Page> createState() => _MyPackage2PageState();
}

class _MyPackage2PageState extends State<MyPackage2Page> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> _materiPage = [
      isi(context, "HematExpress", "14-21 hari", "Rp 40.000","Rp 30.000"),
      isi(context, "MurahExpress", "30 hari", "Rp 20.000", "Rp. 10.000"),
    ];
  ...
  Widget isi(BuildContext context, String nama, String hari, String harga1, String harga2) {
    var tinggi = MediaQuery.of(context).size.height;
    var lebar = MediaQuery.of(context).size.width;
    return Column(
      children: <Widget>[
